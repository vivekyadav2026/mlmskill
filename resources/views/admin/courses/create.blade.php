...
<div class="tailwind-scope mt-4 max-w-2xl mx-auto">
    ...
    <div class="bg-[#1a222d] border border-[#334155] rounded-lg p-6">
        <form method="POST" action="{{ url('admin/courses/create') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4"><label class="block text-gray-300 mb-2">Upload PDF (Optional)</label><input type="file" name="pdf_file" accept=".pdf" class="w-full bg-[#0b1220] border border-[#334155] text-white p-3 rounded"></div>
            <div class="mb-4">

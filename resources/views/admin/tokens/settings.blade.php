...
<div class="tailwind-scope mt-4 max-w-2xl mx-auto">
    ...
    <div class="bg-[#1a222d] border border-[#334155] rounded-lg p-6">
        <form onsubmit="event.preventDefault(); alert('Settings Saved!');">
            <div class="mb-4"><label class="block text-gray-300 mb-2">Daily ROI (NEXA 1.0s)</label><input type="number" step="0.1" class="w-full bg-[#0b1220] border border-[#334155] text-white p-3 rounded" value="1.5"></div>
            <div class="mb-4"><label class="block text-gray-300 mb-2">Daily ROI (NEXA 2.0s)</label><input type="number" step="0.1" class="w-full bg-[#0b1220] border border-[#334155] text-white p-3 rounded" value="0.5"></div>

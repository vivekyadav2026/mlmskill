    ...
    <div class="report-header flex items-center justify-between mb-6 flex-wrap gap-3">
        ...
        <div class="flex items-center gap-2">
            <div class="flex gap-2 mr-4">
                <a href="{{ route('admin.reports.income.excel') }}" class="px-4 py-2 bg-green-700 text-white rounded-lg hover:bg-green-600 transition flex items-center gap-2 text-sm shadow-lg shadow-green-900/20">
                    <i class="fa-solid fa-file-excel"></i> Excel
                </a>
                <a href="{{ route('admin.reports.income.pdf') }}" class="px-4 py-2 bg-red-700 text-white rounded-lg hover:bg-red-600 transition flex items-center gap-2 text-sm shadow-lg shadow-red-900/20">

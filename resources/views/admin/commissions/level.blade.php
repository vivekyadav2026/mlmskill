...
<div class="tailwind-scope mt-4 max-w-[1400px] mx-auto">
    ...
    <div class="flex items-center justify-between mb-6 flex-wrap gap-3">
        ...
        <div class="flex items-center gap-3">
            <form action="{{ url('admin/commissions/level') }}" method="GET" class="flex items-center gap-2 bg-[#1a222d] border border-[#334155] rounded-lg p-1.5">
                ...
                <a href="{{ url('admin/commissions/level') }}" class="bg-gray-600 hover:bg-gray-700 text-white text-xs px-2 py-1.5 rounded transition"><i class="fa-solid fa-xmark"></i></a>
                @endif
            </form>

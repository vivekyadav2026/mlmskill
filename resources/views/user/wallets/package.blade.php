...
<div class="tailwind-scope mt-4">
    <div class="mb-6">
        ...
        <p class="text-gray-400">Funds converted from NEXA 1.0 to be used for Package Upgrades.</p>
    </div>
                ...
                <tbody class="divide-y divide-[#334155]">
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-10 text-center text-gray-500">
                            ...
                            <p class="text-sm mt-2 text-gray-400">Convert NEXA 1.0 to add funds here.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>

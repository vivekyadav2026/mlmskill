            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div>
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <a href="{{ route('forgot.password') }}" class="text-xs text-brand-300 hover:text-white transition font-medium">Forgot password?</a>
                    </div>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        ...
                        <button type="button" onclick="togglePassword('password', 'eye-icon-login')" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-white transition focus:outline-none">
                            <i id="eye-icon-login" class="fa-solid fa-eye"></i>
                        </button>
                    </div>
                </div>
                ...
                <button type="submit" class="w-full bg-gradient-to-r from-brand-600 to-brand-500 hover:from-brand-500 hover:to-brand-400 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-brand-500/30 transition transform hover:-translate-y-0.5 border border-white/10 mt-4">
                    Sign In to Account
                </button>
            </form>

...
<head>
    ...
    <title>Set New Password - Samarth Digital</title>
...
<body class="antialiased font-sans overflow-x-hidden min-h-screen bg-slate-900 relative flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="mt-4 text-brand-100 text-sm font-light tracking-wide">Securely update your password</p>
        </div>

        <!-- Glassmorphism Form Container -->
        <div class="bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl p-8 sm:p-10">
            
            <h2 class="font-heading text-2xl font-bold text-white mb-6 text-center">Set New Password</h2>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-5">
                ...
                <div>
                    <label class="block text-sm font-medium text-brand-100 mb-2">Registered Email</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <i class="fa-solid fa-envelope text-gray-400"></i>
                        </div>
                        <input type="email" name="email" class="w-full pl-11 pr-4 py-3 rounded-xl border border-white/10 bg-white/5 text-gray-400 placeholder-gray-500 outline-none transition" required readonly value="{{ request()->email ?? old('email') }}">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="password" name="password" minlength="6" maxlength="8" class="w-full pl-11 pr-12 py-3 rounded-xl border border-white/10 bg-white/5 text-white placeholder-gray-400 focus:bg-white/10 focus:border-brand-400 focus:ring-1 focus:ring-brand-400 outline-none transition" required placeholder="••••••••">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation" minlength="6" maxlength="8" class="w-full pl-11 pr-12 py-3 rounded-xl border border-white/10 bg-white/5 text-white placeholder-gray-400 focus:bg-white/10 focus:border-brand-400 focus:ring-1 focus:ring-brand-400 outline-none transition" required placeholder="••••••••">
